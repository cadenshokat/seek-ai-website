      ...
      <header className="absolute top-0 left-2 right-0 h-16 flex items-center px-6">
        ...
        <div className="flex items-center gap-1">
          <Button
            variant="ghost"
            size="icon"
            onClick={() => window.open("https://github.com/cadenshokat/seek-ai-website", "_blank")}
          >
      ...
      <div className="w-full max-w-xl p-24">
        ...
        <Separator className="bg-[#e5e5e5]"/>
          <div className="flex flex-col gap-4 items-center mt-6">
                  <Button variant="ghost" className="w-64 text-md border border-md" onClick={handleSocialLogin}>
